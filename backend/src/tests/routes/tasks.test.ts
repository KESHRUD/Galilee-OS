...
describe('Tasks API', () => {
  ...
  it('POST /api/tasks should create a task', async () => {
    const res = await request(app)
      .post('/api/tasks')
      .send({ title: 'Test Task', description: 'Test desc', status: 'todo', priority: 'medium' });
  ...
  it('PUT /api/tasks/:id should update a task', async () => {
    const create = await request(app)
      .post('/api/tasks')
      .send({ title: 'To Update', description: '', status: 'todo', priority: 'low' });
  ...
  it('DELETE /api/tasks/:id should delete a task', async () => {
    const create = await request(app)
      .post('/api/tasks')
      .send({ title: 'To Delete', description: '', status: 'todo', priority: 'low' });
    const id = create.body.data.id;
